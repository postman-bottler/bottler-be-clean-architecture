...
import online.bottler.complaint.adapter.out.persistence.MapReplyComplaintPersistenceAdapter;
...
class MapReplyComplaintPersistenceAdapterTest {
    ...
    void save() {
        ...
        // then
        Complaints complaints = mapReplyComplaintPersistenceAdapter.findByLetterId(complaint.getLetterId());
