...
public class LetterBoxServiceV2 implements LetterBoxUseCase {
    ...
    @Transactional
    @Override
    public void save(Long letterId, Long userId) {
        letterBoxPersistencePort.createForDeveloperLetter(letterId, userId);
    }
    ...
    private void deleteLetter(BoxType boxType, List<Long> ids, Long userId) {
        List<Letter> letters = letterPersistencePort.loadAllByIds(ids);
