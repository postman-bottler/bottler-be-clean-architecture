...
public record LetterRecommendSummaryResponse(Long letterId, String title, String label) {
    public static LetterRecommendSummaryResponse from(Letter letter) {
        return new LetterRecommendSummaryResponse(letter.getId(), letter.getTitle(), letter.getLabel());
    }
