...
import online.bottler.letter.application.facade.KeywordFacade;
...
public class KeywordController {
    ...
    public ApiResponse<String> createKeywords(@RequestBody UserKeywordRequest userKeywordRequest,
        ...
        keywordFacade.createUserKeywords(userKeywordRequest.toCommand(userDetails.getUserId()));
    ...
    public ApiResponse<KeywordResponse> getKeywordList() {
        return ApiResponse.onSuccess(keywordFacade.getKeywordList());
    }
    ...
    public ApiResponse<UserKeywordResponse> getKeywords(@AuthenticationPrincipal CustomUserDetails userDetails) {
        return ApiResponse.onSuccess(keywordFacade.getUserKeywords(userDetails.getUserId()));
    }
    ...
    public ApiResponse<FrequentKeywordsResponse> getTopFrequentKeywords(
            @AuthenticationPrincipal CustomUserDetails userDetails) {
        return ApiResponse.onSuccess(keywordFacade.getTopFrequentKeywords(userDetails.getUserId()));
    }
}
