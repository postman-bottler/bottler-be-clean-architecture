...
import online.bottler.letter.v2.application.port.in.CreateLetterBoxUseCase;
import online.bottler.letter.v2.application.port.in.GetAllLettersUseCase;
import online.bottler.letter.v2.application.port.in.GetReceivedLetterIdsUseCase;
import online.bottler.letter.v2.application.port.in.GetReceivedLettersUseCase;
import online.bottler.letter.v2.application.port.in.GetSentLettersUseCase;
...
public class LetterBoxServiceV2 implements CreateLetterBoxUseCase, GetAllLettersUseCase, GetSentLettersUseCase,
        GetReceivedLettersUseCase,
