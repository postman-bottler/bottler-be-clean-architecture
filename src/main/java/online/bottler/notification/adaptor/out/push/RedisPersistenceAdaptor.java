...
import static online.bottler.notification.adaptor.out.push.NotificationHashKey.NOTIFICATION_KEY;
...
@Slf4j
public class RedisPersistenceAdaptor implements NotificationPersistencePort {
