package online.bottler.global.aop;
...
public class LogAspect {
    ...
    @Pointcut("execution(public * online.bottler.*.presentation..*Controller.*(..))")
    public void controllerPointcut() {
    }

    @Pointcut("execution(public * online.bottler.*.exception.*Handler.*(..))")
