...
import online.bottler.mapletter.infra.entity.MapLetterArchiveEntity;

@Repository
public interface MapLetterArchiveJpaRepository extends JpaRepository<MapLetterArchiveEntity, Long> {

    @Query("SELECT new online.bottler.mapletter.application.dto.response.FindAllArchiveLetters("
